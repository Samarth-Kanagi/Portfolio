      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 py-12">
        <div className="flex flex-col items-center text-center gap-6">
          <a href="#home" className="flex items-center gap-2.5 relative group">
            ...
            <span
              className={`absolute left-1/2 -translate-x-1/2 bottom-full mb-3 px-3 py-1.5 rounded-lg text-xs font-bold whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none z-50 flex items-center gap-2 shadow-xl ${
                dark
          ...
          <p
            className={`text-sm max-w-md ${dark ? "text-gray-500" : "text-gray-500"}`}
          >
        ...
        <div
          className={`mt-10 pt-6 border-t flex flex-col sm:flex-row items-center justify-between text-xs gap-2 ${
            dark
        ...
        >
          <p className="flex items-center gap-2">
            <span className="green-dot"></span>© {new Date().getFullYear()}{" "}
            Samarth Kanagi. All rights reserved.
          </p>
